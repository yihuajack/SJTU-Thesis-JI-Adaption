...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    title           = {密院学位论文 \LaTeX{} 模板},
    title*          = {A Sample Document for \LaTeX-based JI Thesis Template},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    keywords        = {上海交大, 密西根学院, LaTeX模板},
    keywords*       = {SJTU, Joint Institute, LaTeX Template},
    %
    % 姓名
    %
    author          = {某\quad{}某},
    ...
    %
    major           = {电子与计算机工程/机械工程},
    major*          = {Electrical and Computer Engineering/Mechanical Engineering},
    %
    % 所属院系
    %
    department      = {密西根学院},
